...
export default class RealTime extends React.Component {
   ...
   resetCharts = () => {
      ...
      Object.keys(charts).forEach((symb, i) => {
         ...
         let keyy = symb + '_key';
         stateOB[slot] = <CanvasChart key={keyy} newPos={this.newPos } depChg={this.depositChanged } ctx={CtxChart.passCTXconstructor()} clock={Clock} positions={chartPositions[symb]} clCtx={this.closeCrt } dataSource={this.dbSource} mainSym={symb} whenMounted={this.canvasPlaced }/>;
      });
      ...
      return (
         <div>
            <div id="rtTopNavUI">
               ...
               <div className={this.props.rt.addButton ? "add-chart" : "add-chart no-see-no-click"} onClick={this.addChartMenu}>
            ...
            <section id="realTimeTheme">
               ...
               <SideOptions platformView={platformView} optsComponent={optsComponent} tdClass={tdClass} onStart={this.props.rt.onStart} itmView={this.optView}/>
