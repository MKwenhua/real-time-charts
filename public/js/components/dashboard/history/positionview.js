...
const chartMaker = require('../charts.js');
...
export default class PositionView extends React.Component {
   constructor(props) {
      super(props);
      this.chart1 = null;
      this.chart2 = null;
   ...
   render() {
      ...
      return (<div className="view-trd fade-in" >
          <h3 className="under-line span-label-blue margin-btm-sm"> {this.props.pos.position}</h3>
                 {this.props.pos.date}
